...
<html lang="es">
    <head>
        ...
        <title>Pagina de Inicio - MiPlataforma</title>
    ...
    <body>
        ...
        ```
        <header class="navbar">
            <div class="brand">MiPlataforma</div>
        ...
        <main class="hero">
            ...
            <p>Accede a tu cuenta o registrate para comenzar a utilizar nuestros servicios.</p>
        </main>
