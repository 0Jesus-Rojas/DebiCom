...
public class ReporteCompradorDAO {
    ...
    public List<PagoHistorialDTO> listarPagosPorUsuario(int idUsuario) {
        String sql = "SELECT p.id_pago, p.id_factura, f.numero_factura, p.numero_referencia_pago, p.monto_pagado, "
                + "p.fecha_pago, tp.nombre_pago AS tipo_pago, t.nombre_tienda, p.observaciones "
                + "FROM pagos p "
